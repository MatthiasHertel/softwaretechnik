...
\textbf{Der IEEE-Standard 610-1990 definiert SE als:}



\enquote{(1) The application of a systematic, disciplined, quantifiable approach to the development, operation, and maintenance of software; that is, the application of engineering to software. (2) The study of approaches as in (1)}
...
\begin{itemize}
\item SE umfasst Methoden, Techniken und Instrumente zur Erstellung von auf Maschinen lauffähigen Programmen (Software).
\item Ziel von SE ist die Vermeidung von Fehlern, Reduktion von Aufwänden und Erhöhung des Kundennutzens von Software
\item SE beinhaltet das Management von Entwicklungsprojekten für Software.
\item SE umfasst die Inbetriebnahme, den Betrieb und die Wartung von Software.
\item Hierzu beschreibt SE bewährte Vorgehensweisen in Modellen (Vorgehensmodelle) und definiert Qualitätsstufen für den Software-Entwicklungsprozess (CMM, PMMM).
\end{itemize}
